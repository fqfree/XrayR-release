...
install_XrayR() {
    ...
    file="https://github.com/fqfree/XrayR-release/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/fqfree/XrayR-release/master/XrayR.sh
